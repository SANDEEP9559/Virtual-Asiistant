...
print('Loading your Sandeep personal assistant ')
...
speak("Loading your Sandeep virtual assistant ")
wishMe()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "goodbye" in statement or "ok bye" in statement or "stop" in statement:
            speak('Thank You Sandeep Virtual Assistant is now shutting down,Good bye')
            print('your Sandeep Virtual  Assistant  is shutting down,Good bye')
            break
        ...
        if 'wikipedia' in statement:
            ...
            speak("Sandeep Virtual  assistant")
            time.sleep(2)

        elif 'nice to meet you' in statement:

            speak("it's my pleassure sir")
            time.sleep(2)

        elif 'old' in statement:

            speak("am 2 months old developed by my hero Sandeep Kumar")
            time.sleep(2)
            ...
            time.sleep(1)
            speak('whatsapp,facebook,twitter,CarZone')
            print('1. whatsapp,2. facebook,3. twitter, 4. CarZone')
        ...
        elif '4' in statement or "CarZone" in statement:
            webbrowser.open_new_tab("https://tranquil-badlands-18723.herokuapp.com")
            speak("Download & Enjoy Our Projects With Free Source code")
            time.sleep(5)
            ...
            speak(
                'I am Sandeep virtual assistant version 1 point O your persoanl assistant. Developed by Sandeep Kumar. I am programmed to minor tasks like'
            ...
            speak("I was built up by Sandeep Kumar ")
            print("I was built by Sandeep Kumar")
